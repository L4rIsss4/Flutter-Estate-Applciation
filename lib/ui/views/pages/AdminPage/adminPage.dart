import 'package:emlak_project/ui/views/pages/AdminPage/AdminPageKonutDetails.dart';
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => AdminpageKonutDetails(konut: konut),
                        ),
                      );
                    },
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              context.read<AdminPageCubit>().konutsil(konut.konut_id);
                            },
                          ),
                        ),
                      ],
