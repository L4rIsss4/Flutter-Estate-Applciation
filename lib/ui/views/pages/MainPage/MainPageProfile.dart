...
import 'package:emlak_project/ui/views/pages/MainPage/mainPagePasswordChange.dart';
...
class MainPageProfile extends StatefulWidget {
  ...
  @override
  State<MainPageProfile> createState() => _MainPageProfileState();
}
        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>MainPagePasswordChange()));
              },
            ),
            Divider(color: Colors.white24),
            ListTile(
