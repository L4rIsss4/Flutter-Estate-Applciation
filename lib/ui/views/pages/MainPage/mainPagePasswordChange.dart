...
class MainPagePasswordChange extends StatefulWidget {
  const MainPagePasswordChange({super.key});

  @override
  State<MainPagePasswordChange> createState() => _MainPagePasswordChangeState();
}

class _MainPagePasswordChangeState extends State<MainPagePasswordChange> {
